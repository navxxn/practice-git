...
# # Get-ChildItem -Path '/Users/shady/Documents/Socgen/techademy/azure/' -Recurse | Set-AzStorageBlobContent -Container "mycontainer" -Context $context -force

# # $all = Get-AzStorageBlob -container 'mycontainer' -context $context

# # $all | ForEach-Object { Get-AzStorageBlobContent -Container 'mycontainer' -Context $context -Blob $_.Name -Destination '/Users/shady/Documents/Socgen/techademy/azure/test/' }

# # Get-AzStorageBlob -container 'mycontainer' -context $context | Get-AzStorageBlobContent -Container 'mycontainer' -Context $context -Blob $_.Name -Destination '/Users/shady/Documents/Socgen/techademy/azure/test/'

# Get-AzStorageAccount -ResourceGroupName 'cloud-shell*'
